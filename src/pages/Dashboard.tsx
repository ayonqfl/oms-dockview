        ...
        <div className="dashboard-card account-snapshot">
          ...
          <div className="card-content">
            <div className="metric">
              ...
              <span className="metric-value large">{accountSnapshot.totalValue}</span>
            </div>
            <div className="metrics-grid">
              <div className="metric">
                <span className="metric-label">Daily Change</span>
                <span className="metric-value positive">{accountSnapshot.dailyChange}</span>
              </div>
              <div className="metric">
                <span className="metric-label">Monthly Change</span>
                <span className="metric-value positive">{accountSnapshot.monthlyChange}</span>
              </div>
              <div className="metric">
                <span className="metric-label">Annual Return</span>
                <span className="metric-value positive">{accountSnapshot.annualReturn}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="dashboard-card portfolio-health">
          ...
          <div className="health-indicators">
            ...
            <div className="health-indicator">
              ...
              <div className="indicator-value">{portfolioHealth.diversification}</div>
            ...
            {topSectors.map((sector, index) => (
              <div key={index} className="list-item">
                ...
                <div className="item-details">
                  <span className="item-allocation">{sector.allocation}</span>
                  <span className="item-performance positive">{sector.performance}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="list-container">
            {topInvestors.map((investor, index) => (
              <div key={index} className="list-item">
                ...
                <div className="item-details">
                  <span className="item-allocation">{investor.allocation}</span>
                  <span className="item-performance positive">{investor.performance}</span>
                </div>
              </div>
            ))}
          </div>
